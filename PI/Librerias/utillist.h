...
//una función que reciba un número entero i y devuelve el i-ésimo elemento, donde el primer elemento tiene el índice cero
int iList(TList list, int i);


//
void map(TList list, fn f);
#endif